...
public class ReturnOrderServiceImpl implements ReturnOrderService {
    ...
    public void agreeRefund(String id, Integer money, Integer adminId) {
        ...
        returnOrderMapper.updateByPrimaryKeySelective(returnOrder); //更新
    ...
    public void rejectRefund(String id, String remark, Integer adminId) {
        ...
        if (remark.length() < 5) {
            throw new RuntimeException("理由不足，多输入点");
        }
        //修改属性
        ...
        //修改对应订单项的申请状态为未申请，通过ReturnOrderItem中字段returnOrderId=id的记录，查找到对应的OrderItem
        ...
        for (ReturnOrderItem returnOrderItem : returnOrderItems) {
            ...
            orderItem.setIsReturn("0"); //未申请退款
            orderItemMapper.updateByPrimaryKeySelective(orderItem); //更新状态，以后可以重新发起退款申请
        }
    }
